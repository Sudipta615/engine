...
/// the VBAP-style object renderer, `Ambisonic` the FOA-bus decoder; a
/// Binaural renderer is a documented later-phase seam (spec §23, §136)
/// added to this enum without breaking existing match arms.
